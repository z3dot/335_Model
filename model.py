...
class TranslationDataset(Dataset):
    ...
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq)
        ...
        self.seq = seq
        self.ds = ds
        self.tokeniser_src = tokenizer_src
        ...
        self.eos_token = torch.tensor([tokenizer_tgt.token_to_id("[PAD]")], dtype=torch.int64)
    ...
    def __getitem__(self, idx):
        ...
        #Double check the size of the Tensor to make sure the are all seq long
